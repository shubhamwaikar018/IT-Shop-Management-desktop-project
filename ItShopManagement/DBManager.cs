...
namespace ItShopManagement
{
    ...
    public class DBManager
    {
        ...
        public DBManager()
        {
            connnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\ItShopManagement\ItShopManagement\Itshop.mdf;Integrated Security=True;";
        ...
        private void HandleConnnection()
        {
